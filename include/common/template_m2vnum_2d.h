...
#define DEFINE_TEMPLATE_M2VNUM_2D(name, rt, p1t, p2t, gf)                      \
    template <typename T>                                                      \
    class name##_functor : public functor_m2vnum_2d<name##_functor<T>, T, rt>  \
    {                                                                          \
      public:                                                                  \
        name##_functor(const T &x)                                             \
            : functor_m2vnum_2d<name##_functor<T>, T, rt>(x)                   \
        {                                                                      \
        }                                                                      \
                                                                               \
        rt m2vnum_impl(p1t x1, p2t x2) const                                   \
        {                                                                      \
            return gf(x1, x2);                                                 \
        }                                                                      \
    };                                                                         \
...
#define DEFINE_TEMPLATE_M2VNUM_2D_E(name, rt, p1t, p2t, gfe)                   \
    template <typename T, typename U>                                          \
    class name##_e_functor                                                     \
        : public functor_m2vnum_2d_e<name##_e_functor<T, U>, T, U, rt>         \
    {                                                                          \
      public:                                                                  \
        name##_e_functor(const T &x, U &e)                                     \
            : functor_m2vnum_2d_e<name##_e_functor<T, U>, T, U, rt>(x, e)      \
        {                                                                      \
        }                                                                      \
                                                                               \
        rt m2vnum_e_impl(p1t x1, p2t x2, double &e) const                      \
        {                                                                      \
            gsl_sf_result r;                                                   \
            gfe(x1, x2, &r);                                                   \
            e = r.err;                                                         \
    ...
    {                                                                          \
        static_assert(TYPE_IS(typename T::Scalar, p1t),                        \
                      "only support " #p1t " scalar");                         \
                                                                               \
