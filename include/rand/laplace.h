...
#ifndef __IEXP_RAND_LAPLACE__
#define __IEXP_RAND_LAPLACE__
  ...
  public:
    ...
    class rng
    {
      public:
        ...
        double next()
        {
            return gsl_ran_laplace(m_rng.gsl(), m_a);
        }
    ...
    template <typename T>
    static inline auto fill(DenseBase<T> &x, laplace::rng &r)
        -> decltype(x.derived())
    {
